...
4. **Multi-agent** — graphs, swarms, and workflow-style composition are part of the ecosystem for larger tasks; align specialist code with `l3_runtime/` and `references/STRANDS_SDK.md` reading order.
